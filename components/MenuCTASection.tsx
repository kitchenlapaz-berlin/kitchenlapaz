  ...
  const menuCategories = [
    {
      title: "Nachos",
      items: [
        { name: "Nachos Con Queso", desc: "Mit Käse überbackene Tortillachips, Jalapeños, Guacamole, Salsa", price: "14.50" },
        { name: "Nachos Tijuana", desc: "Bohnenpüree auf Tortillachips, Käse, Jalapeños, Guacamole", price: "14.50" },
        { name: "Nachos de Pollo", desc: "Hähnchenfleisch auf Tortillachips, Käse, Guacamole, Salsa", price: "14.90" },
      ]
    },
    {
      title: "Tacos & Classics",
      items: [
        { name: "Tacos „La Paz“", desc: "Knusprige Maistortillaschalen mit Rinderhack & Hähnchen", price: "21.50" },
        { name: "Burrito de Carne", desc: "Weizentortilla mit Rinderhack, Reis, Bohnen, Salat", price: "18.90" },
        { name: "Fajitas de Pollo", desc: "Gebratene Hähnchenbruststreifen, Zwiebeln, Paprika", price: "23.90" },
        { name: "Chimichanga al Horno", desc: "Weizentortillas mit Gemüsefüllung, Käse überbacken", price: "18.50" },
      ]
    },
    {
      title: "Burger",
      items: [
        { name: "La Paz Burger", desc: "Cheddar Käse, Herzhafte Tomaten, Zwiebeln, Gewürzgurken", price: "15.90" },
        { name: "Texas Burger", desc: "Cheddar Käse, Jalapeños, Gegrillte Paprika", price: "15.90" },
        { name: "BBQ Burger", desc: "Cheddar Käse, Knuspriger Schinken, Röstzwiebeln, BBQ Sauce", price: "16.50" },
      ]
    }
  ];
